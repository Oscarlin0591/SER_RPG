...
public class Shrek extends Enemy {
    ...
    public Shrek(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Shrek.png"), 40, 40), "STAND_RIGHT", -1, -1, -1, -1);
    }

    public Shrek(int id, Point location, float health, float strength, float newCritChance, float newDodgeChance) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("Shrek.png"), 40, 40), "STAND_RIGHT", health, strength, newCritChance, newDodgeChance);
    }

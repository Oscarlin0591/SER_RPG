...
public class DeadTree2 extends NPC{
    public DeadTree2(int id, Point location) {
        super(id, location.x, location.y, new SpriteSheet(ImageLoader.load("AnimatedSprites/DeadTree2.png"), 64,92), "STAND_RIGHT");
    }

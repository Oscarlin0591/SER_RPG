...
import Scripts.StartIslandMap.ThugScript;
...
public class CaveMap extends Map {
    ...
    public ArrayList<NPC> loadNPCs() {
        ...
        Boy boy = new Boy(22,getMapTile(8,6).getLocation());
        boy.setInteractScript(new BoyScript());
        npcs.add(boy);

        Thug thug = new Thug(35,getMapTile(14,5).getLocation());
        thug.setInteractScript(new ThugScript());
        npcs.add(thug);

    ...
    public ArrayList<ScriptAction> loadScriptActions() {
        ...
        scriptActions.add(new ConditionalScriptAction() {{
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
                addRequirement(new FlagRequirement("capricornQuestCompleted", true));
                addScriptAction(new TextboxScriptAction() {{
                    addText("Ye helped me out, thank you human.");
                }});
            }});
        }});
        ...
        scriptActions.add(new ConditionalScriptAction() {{
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
            addRequirement(new FlagRequirement("capricornQuestCompleted", false));
            addScriptAction(new TextboxScriptAction() {{
        ...
        scriptActions.add(new ConditionalScriptAction() {{
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
                addRequirement(new CustomRequirement() {
                    ...
                    addScriptAction(new ChangeFlagScriptAction("capricornGameTriggered", true));

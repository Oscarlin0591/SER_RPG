    ...
    public ArrayList<ScriptAction> loadScriptActions() {
        ...
        scriptActions.add(new ConditionalScriptAction() {{
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
                addRequirement(new CustomRequirement() {
                    ...
                    public boolean isRequirementMet() {
                        return !PlayLevelScreen.getMap().getFlagManager().isFlagSet("badShipKilled");
                    }
                });
            ...
            addConditionalScriptActionGroup(new ConditionalScriptActionGroup() {{
                ...
                addScriptAction(new TextboxScriptAction(){{
                    addText("I can't thank ye enough for yer assistance.");
                    addText("That truly was a formidable ship.");
                    addText("Guess there's back to only bein one of me ship sailin around.");
                    addText("Strange seas...");
                }});
            }});
        }});
